...
`s03e04_negotiations/` — **implementacja gotowa** (2026-08-19), czeka na przebieg
na żywo. Odwrócone role: my wystawiamy 2 narzędzia HTTP (port 8004), agent
Centrali je odpytuje i sam zgłasza znalezione miasta. Zero LLM — dopasowanie po
rdzeniach tokenów obsługuje polską odmianę. Hub wymaga DOKŁADNIE 2 narzędzi i
